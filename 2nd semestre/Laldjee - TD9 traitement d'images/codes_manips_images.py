...
print(getcwd())
chdir(r"\users\antoinelaldjee-derou\desktop\python\2nd semestre\laldjee - td9 traitement d'images")
...
image1 = plt.imread("ecureuil_leger.jpg").tolist()
